...
export class PocketBaseClient {
    ...
    create(collection: string, data: any) {
        return this.collection(collection).create(data);
    }
    update(collection: string, id: string, data: any) {
        return this.collection(collection).update(id, data);
    }
    getFullList(collection: string, params: any = {}) {
        return this.collection(collection).getFullList(params);
    }
    getOne(collection: string, id: string) {
        return this.collection(collection).getOne(id);
    }
}
